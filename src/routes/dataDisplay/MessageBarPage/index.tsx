...
const log = (text: string): (() => void) => (): void => alert(text);

class MessageBarPage extends React.Component {
    public render() {
        return (
            <div className="container">
                <div>
                    <h1 className="Heading">Message Bar</h1>
                    <div className="ContentCard">
                        <h2 className="Heading">Message Bar</h2>
